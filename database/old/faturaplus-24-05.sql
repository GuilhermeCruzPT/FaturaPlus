...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 24-Maio-2022 às 08:48
...
INSERT INTO `users` (`id`, `username`, `password`, `image`, `name`, `email`, `phone`, `nif`, `postal_code`, `birth`, `genre`, `coutry`, `city`, `locale`, `address`, `role`) VALUES
